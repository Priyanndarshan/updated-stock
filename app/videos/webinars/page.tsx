...
// Sample webinar videos
const webinarVideos = [
  {
    id: 1,
    title: "Market Outlook 2025: Opportunities and Challenges",
  ...
  {
    id: 2,
    title: "Sector Analysis: Technology Stocks",
    ...
    rating: 4.8,
    viewers: 2367,
    description: "Deep dive into the technology sector and potential investment opportunities."
  },
  {
    id: 3,
    ...
    rating: 4.7,
    viewers: 1876,
    description: "Analysis of global economic trends and their implications for Indian markets."
  },
  {
    id: 4,
    title: "Budget Impact Analysis: What It Means for Investors",
    ...
    rating: 4.6,
    viewers: 2145,
    description: "Detailed analysis of the budget and its implications for different sectors and investors."
  },
  {
    id: 5,
    title: "Emerging Investment Themes for 2025",
    ...
    rating: 4.8,
    viewers: 2543,
    description: "Exploring emerging investment themes and opportunities for the year ahead."
  },
  {
    id: 6,
    title: "Navigating Volatility: Risk Management Strategies",
    ...
    rating: 4.7,
    viewers: 1987,
    description: "Strategies for managing risk and navigating market volatility effectively."
  }
];
...
export default function WebinarsPage() {
  ...
  const filteredVideos = React.useMemo(() => {
    return webinarVideos.filter(video => {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-3">
          ...
          <span className="text-gray-800 font-medium">Webinars</span>
        </div>
        
        {/* Page Title */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-800 mb-1">Market Webinars</h1>
          <p className="text-gray-500">Expert webinars on market trends, sectors, and investment opportunities</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredVideos.length > 0 ? (
            ...
            <div className="col-span-full flex flex-col items-center justify-center py-12 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-800 mb-1">No webinars found</h3>
