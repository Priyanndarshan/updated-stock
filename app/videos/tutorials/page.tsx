...
const tutorialVideos = [
  {
    ...
    rating: 4.9,
    viewers: 2367,
    description: "Learn the basics of options trading from expert traders."
  },
  {
    id: 2,
  ...
  },
  {
    ...
    rating: 4.9,
    viewers: 2245,
    description: "Comprehensive guide to understanding and trading with candlestick patterns."
  },
  {
    id: 6,
    ...
    rating: 4.7,
    viewers: 1845,
    description: "Introduction to futures trading concepts and strategies for beginners."
  }
];
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-3">
          ...
          <span className="text-gray-800 font-medium">Tutorials</span>
        </div>
        
        {/* Page Title */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-800 mb-1">Tutorial Videos</h1>
          <p className="text-gray-500">Learn trading concepts and strategies with our step-by-step tutorials</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredVideos.length > 0 ? (
            ...
            <div className="col-span-full flex flex-col items-center justify-center py-12 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-800 mb-1">No tutorials found</h3>
